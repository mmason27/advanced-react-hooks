...
1. What is a typical use case for useReducer? An object of state
2. What arguments does your reducer function take? State and action
3. When should you use useState over useReducer? When it's just an independent
   element of state you're managing
4. When would useReducer be a better hook to use? When one element of your state
   relies on the value of another element of your state in order to update
