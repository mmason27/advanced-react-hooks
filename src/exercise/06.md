...
1. What does useDebugValue do? It can be used to display a label for custom
   hooks in React DevTools.
2. When is it recommended to add debug values to custom hooks? This hook is most
   valuable for custom hooks that are part of shared libraries.
