...
1. What does useImperativeHandle do? It customizes the instance value that is
   exposed to parent components when using ref
2. How often should you use this hook? As with any imperative code (vs
   declarative) using refs should be avoided in most cases
3. What should it be used in conjunction with? forwardRef
